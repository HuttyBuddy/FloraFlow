# FloraFlow Marketing Goals — Q3 2026

## Quarter Focus: User Acquisition

This quarter's primary objective is growing the FloraFlow user base. All marketing efforts and success metrics should ladder up to driving new installs, signups, and activated accounts.
...
*Note: Replace TBD targets with Q2 baseline data and Q3 projections.*
...
- [ ] Produce first YouTube Shorts batch (5–10 clips) repurposed from long-form content
- [ ] Add YouTube channel link and install CTA to video descriptions and channel banner
- [ ] Identify and brief 5–10 micro-influencers for Q3 partnerships
- [ ] Set up conversion tracking for activation event in Google Analytics / Firebase

## What Success Looks Like

By end of Q3, FloraFlow should have meaningfully grown its active user base, established repeatable paid acquisition channels with known unit economics, and built organic momentum through content and influencer activity that compounds into Q4.
