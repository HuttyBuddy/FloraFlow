...
@Database(entities = [GardenLayout::class, Plant::class, MoodLog::class, CommunityPost::class, CommunityComment::class, CareTask::class, RestorationLog::class, AssessmentResult::class], version = 7, exportSchema = false)
