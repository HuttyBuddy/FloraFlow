...
- Condescension or "beginner vs. expert" framing
- Hype or exaggeration — we let the product speak
- Passive, impersonal copy

## Voice in Practice

| Context | FloraFlow says | FloraFlow doesn't say |
|---|---|---|
...
- Use **"you"** — speak directly to the user
- Prefer **active voice**
- Use **contractions** — "you'll", "it's", "let's" — to keep copy conversational
- Plant names: use **common names first**, scientific names in parentheses where helpful (e.g., lavender *(Lavandula angustifolia)*)
- Measurements: use both imperial and metric where space allows
